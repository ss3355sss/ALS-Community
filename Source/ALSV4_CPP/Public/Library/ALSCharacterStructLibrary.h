...
struct FALSMantleAsset
{
	...
	UPROPERTY(EditAnywhere, Category = "Mantle System")
	FVector StartingOffset = FVector(0);
...
struct FALSHitFX : public FTableRowBase
{
	...
	UPROPERTY(EditAnywhere, Category = "Sound")
	FVector SoundLocationOffset = FVector(0);

	UPROPERTY(EditAnywhere, Category = "Sound")
	FRotator SoundRotationOffset = FRotator(0);
	...
	UPROPERTY(EditAnywhere, Category = "Decal")
	FVector DecalSize = FVector(0);

	UPROPERTY(EditAnywhere, Category = "Decal")
	FVector DecalLocationOffset = FVector(0);

	UPROPERTY(EditAnywhere, Category = "Decal")
	FRotator DecalRotationOffset = FRotator(0);
	...
	UPROPERTY(EditAnywhere, Category = "Niagara")
	FVector NiagaraLocationOffset = FVector(0);

	UPROPERTY(EditAnywhere, Category = "Niagara")
	FRotator NiagaraRotationOffset = FRotator(0);
};
